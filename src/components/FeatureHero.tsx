  ...
  return (
    <section className="relative overflow-hidden rounded-[2rem] border border-[#2d261c] bg-[#18140f] p-5 text-white shadow-[0_24px_80px_-36px_rgba(24,20,15,0.8)] sm:p-6">
      ...
      <div className="relative grid gap-5 xl:grid-cols-[1.35fr_0.9fr] xl:items-end">
        <div>
          <Badge className="mb-3 border-white/15 bg-white/10 text-white hover:bg-white/10">{eyebrow}</Badge>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-[#d9cdbf] sm:text-base">{description}</p>
            </div>
          </div>
        </div>
